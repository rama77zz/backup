// VERCEL FIX: xlsx dan blob di-load normal
// pdf-parse di-load LAZY saat dibutuhkan agar tidak crash cold start
    ...
    async getAllDocuments() {
        ...
        try {
            ...
            for (const blob of blobs) {
                ...
                // VERCEL FIX: Blob store private → wajib kirim Authorization header
                ...
                // =========================================================================
                // JALUR 2: PROSES PEMBACAAN FILE PDF — LAZY LOAD pdf-parse
                // =========================================================================
                else if (ext === '.pdf') {
                    try {
                        // VERCEL FIX: require di dalam fungsi (lazy) agar tidak crash cold start
